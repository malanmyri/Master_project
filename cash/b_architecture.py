...
class Net(nn.Module):
    def __init__(self, 
        ...
        self.channels_1 = [self.num_stacked,10,10]                                                            
        self.kernels_1 = [11,7]   
                                                                           # Defining the kernel sizes for the convolutional layers

        self.channels_2 = [3*10,10,10]
        self.kernels_2 = [11,7]
        ...
        self.se_block_1 = SE_Block(channel=self.channels_1[-1])  
        self.se_block_2 = SE_Block(channel=self.channels_2[-1])  
    ...
    def forward(self, x1, x2, x3):
        ...
        for layer in self.layer_1:
            ...
            GX1X3 = layer(GX1X3)
            GX2X3 = layer(GX2X3)
            GX1X2 = self.se_block_1(GX1X2)
            GX1X3 = self.se_block_1(GX1X3)
            GX2X3 = self.se_block_1(GX2X3)
