...
class Net(nn.Module):
    def __init__(self, 
        ...
        self.linear = nn.Linear((2 * self.max_tau + 1)*self.channels_2[-1], 2)          # Initializing the linear layer
    ...
    def forward(self, x1, x2, x3):
        ...
        cc = self.linear(cc)                                                                     # Applying the softmax activation function to the GCC-PHAT tensor
        return cc
